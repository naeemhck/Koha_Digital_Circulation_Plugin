...
- Phase 2B staff approval and rejection
- Phase 2C authoritative digital-loan issuance
- Staff Issue Loan API and UI
- Production loan-duration policy
- Phase 3A portal-service loan-read API

## Validation
- Koha-host tests: 35 files / 2,884 assertions / 0 failures
