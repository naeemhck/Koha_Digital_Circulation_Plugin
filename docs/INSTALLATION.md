...
3. Run `./scripts/validate-package.sh dist/JunaidZaidiLibrary-DigitalCirculation-v0.2.2.kpz` and `unzip -l` to inspect every member. Confirm the package includes the Circulation shortcut staff asset and authoritative return runtime modules and route.
