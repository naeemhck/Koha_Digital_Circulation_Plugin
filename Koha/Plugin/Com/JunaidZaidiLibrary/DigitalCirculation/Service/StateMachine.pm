...
my %RULES=(request=>{PENDING=>{map{$_=>1}qw(APPROVED REJECTED CANCELLED)}},loan=>{ACTIVE=>{map{$_=>1}qw(RENEWAL_PENDING RETURNED EXPIRED REVOKED)},RENEWAL_PENDING=>{ACTIVE=>1}},renewal=>{PENDING=>{map{$_=>1}qw(APPROVED REJECTED CANCELLED)}});
