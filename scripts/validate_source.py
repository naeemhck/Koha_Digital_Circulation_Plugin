...
def check_source() -> None:
    ...
    require(f"our $VERSION             = '{PLUGIN_VERSION}';" in source, "plugin version is 0.4.1")
    ...
    require(
        ...
        and "SELECT DISTINCT item.biblionumber, item.itype AS item_type" in report_definitions
        and "my $item_type_filter = sub" in report_definitions,
...
def check_archive(path: pathlib.Path) -> None:
    ...
    with zipfile.ZipFile(path) as archive:
        ...
        require(
            ...
            "packaged internal plugin version is 0.4.1",
        )
        require(
