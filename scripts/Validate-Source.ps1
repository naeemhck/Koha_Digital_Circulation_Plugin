...
Assert-Contract ($source.Contains("our `$VERSION             = '0.4.4';")) 'plugin version is 0.4.4'
...
if ($Kpz) {
    ...
    Assert-Contract ($packagedMain.Contains("our `$VERSION             = '0.4.4';")) 'packaged internal plugin version is 0.4.4'
