...
Version **0.2.3**, schema **1**, tested against Koha **26.05.01.000**
...
EbookContent **0.1.2**. Version **0.2.3** combines the Circulation-home
...
with `unzip -l dist/JunaidZaidiLibrary-DigitalCirculation-v0.2.3.kpz`, then
