...
Version **0.3.1**, schema **1**, tested against Koha **26.05.01.000**
...
EbookContent **0.1.2**. Version **0.3.1** combines the Circulation-home
...
with `unzip -l dist/JunaidZaidiLibrary-DigitalCirculation-v0.3.1.kpz`, then
